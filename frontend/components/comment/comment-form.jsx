...
const CommentForm = ({ commentable_id, commentable_type }) => {
  ...
  return <section className="comment-form-container">
    <UserIcon className="comment-form-user-icon" userId={userId} />
    <Textarea
      ...
      onKeyDown={submit(text, userId, commentable, dispatch, setText)} />
  </section>;
};

const submit = (text, userId, commentable, dispatch, clearField) => (e) => {
